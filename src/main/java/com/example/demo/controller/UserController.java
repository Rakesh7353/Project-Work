...
public class UserController {
	...
	/*
	 * @GetMapping("/pay") public String pay(@RequestParam String email) {
	 * 
	 * boolean paymentStatus = false; if (paymentStatus == true) { User user =
	 * service.getUser(email); user.setPremium(true); } return "login"; }
	 */
	@GetMapping("/logout")
